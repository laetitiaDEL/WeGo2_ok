 ...
 */
class getPetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PetRepository' shared autowired service.
     *
     * @return \App\Repository\PetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PetRepository.php';

        return $container->privates['App\\Repository\\PetRepository'] = new \App\Repository\PetRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
