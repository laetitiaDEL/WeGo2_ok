 ...
 */
class getOutingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OutingRepository' shared autowired service.
     *
     * @return \App\Repository\OutingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OutingRepository.php';

        return $container->privates['App\\Repository\\OutingRepository'] = new \App\Repository\OutingRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
